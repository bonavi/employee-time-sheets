-- Я решил пойти по пути удобства и расширяемости функционала, для своего проекта я делал что-то подобное посредством языка и конкатенации строк, для задачи на чистом SQL мне пришось устанавливать MSSQL и учиться писать динамические запросы

-- Времязатраты: 2.5 часа с установкой MSSQL
